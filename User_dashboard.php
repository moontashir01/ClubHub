...
<head>
    ...
    <style>
        ...
        /* --- SLIDER SECTION (Logic same to same) --- */
        ...
        /* The Button/Card Design */
        .club-card { 
            background: var(--card); border: none; border-radius: 8px; overflow: hidden; 
            cursor: pointer; transition: 0.4s; padding: 0; width: 100%; color: white;
        }
        ...
        .club-card .label { padding: 15px; font-size: 1rem; font-weight: bold; text-align: center; font-family: inherit; }
...
<body>
    ...
    <script>
        // Keep Slider Logic Same to Same
        const contentData = [
