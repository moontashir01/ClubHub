...
<body>
    ...
    <div class="cards-container">
        <a href="room_booking.php" class="dashboard-card">
            <div class="icon">🏢</div>
            <div class="title">New Room Booking</div>
            <div class="desc">Request a room for your event.</div>
        </a>

        <a href="approved_rooms.php" class="dashboard-card">
            <div class="icon">🔍</div>
            <div class="title">Preview Status</div>
            <div class="desc">Track the current status of your room bookings.</div>
        </a>
    </div>
