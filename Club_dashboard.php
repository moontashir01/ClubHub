...
<head>
    ...
    <title>ClubHub | Club Portal</title>
    <style>
        :root { --pink: #ff4d8d;
         --dark-bg: #0b0b13; 
         --card: #161621;
...
<body>
    ...
    <nav>
        ...
        <div><span style="background:var(--pink); padding:6px 15px; border-radius:4px; font-weight:bold; cursor:pointer;">View Members</span> | <span style="background:var(--pink); padding:6px 15px; border-radius:4px; font-weight:bold; cursor:pointer;">Current Events</span></div>
    </nav>
